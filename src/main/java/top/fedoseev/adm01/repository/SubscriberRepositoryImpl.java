...
public class SubscriberRepositoryImpl implements SubscriberRepository {
    ...
    private static final BeanPropertyRowMapper<SubscriberTo> ROW_MAPPER = BeanPropertyRowMapper.newInstance(SubscriberTo.class);
...
int count= this.namedParamJdbcTemplate.queryForInt(namecount, namedParams);*/
    ...
    public List<SubscriberTo> get(long accountNumber) {
        String sql = "SELECT * FROM Subscriber WHERE account_number LIKE '" + accountNumber +
